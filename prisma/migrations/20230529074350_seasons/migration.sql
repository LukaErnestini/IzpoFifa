/*
  ...
  - You are about to drop the `PlayersInGameday` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `PlayersInTeam` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."Attempt" DROP CONSTRAINT "Attempt_teamId_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."Foul" DROP CONSTRAINT "Foul_teamId_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."PlayersInGameday" DROP CONSTRAINT "PlayersInGameday_gamedayId_fkey";

-- DropForeignKey
ALTER TABLE "public"."PlayersInGameday" DROP CONSTRAINT "PlayersInGameday_playerId_fkey";

-- DropForeignKey
ALTER TABLE "public"."PlayersInTeam" DROP CONSTRAINT "PlayersInTeam_playerId_fkey";

-- DropForeignKey
ALTER TABLE "public"."PlayersInTeam" DROP CONSTRAINT "PlayersInTeam_teamId_fkey";
...
-- DropTable
DROP TABLE "public"."PlayersInGameday";

-- DropTable
DROP TABLE "public"."PlayersInTeam";
...
-- AddForeignKey
ALTER TABLE "Foul" ADD CONSTRAINT "Foul_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PlayersInTeam" ADD CONSTRAINT "PlayersInTeam_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PlayersInTeam" ADD CONSTRAINT "PlayersInTeam_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player"("id") ON DELETE CASCADE ON UPDATE CASCADE;
